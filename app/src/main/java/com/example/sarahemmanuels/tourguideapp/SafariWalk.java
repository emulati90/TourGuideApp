...
public class SafariWalk extends AppCompatActivity {
    ImageSwitcher sw;
    Button previousBtn;
    Button nextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sw.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ImageView slideView= new ImageView(SafariWalk.this);
        ...
        siteinfo.add(new SiteInfo(getString(R.string.safariinfo), getString(R.string.fees), getString(R.string.time)));
