...
public class UhuruGardens extends AppCompatActivity {
    ImageSwitcher sw;
    Button previousBtn;
    Button nextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sw.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ImageView slideView= new ImageView(UhuruGardens.this);
        ...
        siteinfo.add(new SiteInfo(getString(R.string.uhuruinfo), getString(R.string.fees), getString(R.string.time)));
