...
public class Bomas extends AppCompatActivity {
    ImageSwitcher sw;
    Button previousBtn;
    Button nextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sw.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ImageView slideView= new ImageView(Bomas.this);
        ...
        siteinfo.add(new SiteInfo(getString(R.string.bomasinfo), getString(R.string.fees), getString(R.string.time)));
