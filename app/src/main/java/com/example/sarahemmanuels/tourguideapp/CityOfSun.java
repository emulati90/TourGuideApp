...
public class CityOfSun extends AppCompatActivity {
    ImageSwitcher sw;
    Button previousBtn;
    Button nextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sw.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ImageView slideView= new ImageView(CityOfSun.this);
        ...
        siteinfo.add(new SiteInfo(getString(R.string.cityinfo), getString(R.string.fees), getString(R.string.time)));
